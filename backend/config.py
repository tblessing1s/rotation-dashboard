...
#   63 trading bars ago.
# - RS3M_MOM: ((current RS3M - (rs[68] / rs[131] - 1) * 100) / prior) * 100,
#   matching the supplied Thinkorswim study exactly.
